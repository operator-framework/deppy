...
func (h *Search) Variables() []pkgsat.Variable {
	result := make([]pkgsat.Variable, 0, len(h.guesses))
	for _, g := range h.guesses {
		if g.m != z.LitNull {
...
func (h *Search) Conflicts() []pkgsat.AppliedConstraint {
